...
CLF_FILEDIR = '/scratch/jialin/round-15/learned_parameters'
OUTPUT_FILEDIR = '/scratch/jialin/round-15/'

param_names = ['learning_rate', 'max_depth', 'n_estimators', 'max_features', 'min_samples_leaf', 'min_samples_split', 'subsample']
schema_template = {
    "learning_rate": {
...
# with open(os.path.join(OUTPUT_FILEDIR, 'metaparameters_schema_.json'), 'w') as outfile:
